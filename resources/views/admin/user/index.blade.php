...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="member_add('批量添加','/admin/user/insert','','510')" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量添加</a> <a href="javascript:;" onclick="member_add('添加用户','/admin/user/create','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a></span> <span class="r">共有数据：<strong>88</strong> 条</span> </div>
	<div class="mt-20">
